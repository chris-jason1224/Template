...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private int mIndicatorSelectedResId = R.drawable.core_ui_gray_radius;
    private int mIndicatorUnselectedResId = R.drawable.core_ui_white_radius;
    private int mLayoutResId = R.layout.core_ui_banner_layout;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.core_ui_Banner);
        mIndicatorWidth = typedArray.getDimensionPixelSize(R.styleable.core_ui_Banner_core_ui_indicator_width, indicatorSize);
        mIndicatorHeight = typedArray.getDimensionPixelSize(R.styleable.core_ui_Banner_core_ui_indicator_height, indicatorSize);
        mIndicatorSelectedWidth = typedArray.getDimensionPixelSize(R.styleable.core_ui_Banner_core_ui_indicator_selected_width, indicatorSize);
        mIndicatorSelectedHeight = typedArray.getDimensionPixelSize(R.styleable.core_ui_Banner_core_ui_indicator_selected_height, indicatorSize);
        mIndicatorMargin = typedArray.getDimensionPixelSize(R.styleable.core_ui_Banner_core_ui_indicator_margin, BannerConfig.PADDING_SIZE);
        mIndicatorSelectedResId = typedArray.getResourceId(R.styleable.core_ui_Banner_core_ui_indicator_drawable_selected, R.drawable.core_ui_gray_radius);
        mIndicatorUnselectedResId = typedArray.getResourceId(R.styleable.core_ui_Banner_core_ui_indicator_drawable_unselected, R.drawable.core_ui_white_radius);
        scaleType = typedArray.getInt(R.styleable.core_ui_Banner_core_ui_image_scale_type, scaleType);
        delayTime = typedArray.getInt(R.styleable.core_ui_Banner_core_ui_delay_time, BannerConfig.TIME);
        scrollTime = typedArray.getInt(R.styleable.core_ui_Banner_core_ui_scroll_time, BannerConfig.DURATION);
        isAutoPlay = typedArray.getBoolean(R.styleable.core_ui_Banner_core_ui_is_auto_play, BannerConfig.IS_AUTO_PLAY);
        titleBackground = typedArray.getColor(R.styleable.core_ui_Banner_core_ui_title_background, BannerConfig.TITLE_BACKGROUND);
        titleHeight = typedArray.getDimensionPixelSize(R.styleable.core_ui_Banner_core_ui_title_height, BannerConfig.TITLE_HEIGHT);
        titleTextColor = typedArray.getColor(R.styleable.core_ui_Banner_core_ui_title_textcolor, BannerConfig.TITLE_TEXT_COLOR);
        titleTextSize = typedArray.getDimensionPixelSize(R.styleable.core_ui_Banner_core_ui_title_textsize, BannerConfig.TITLE_TEXT_SIZE);
        mLayoutResId = typedArray.getResourceId(R.styleable.core_ui_Banner_core_ui_banner_layout, mLayoutResId);
        bannerBackgroundImage = typedArray.getResourceId(R.styleable.core_ui_Banner_core_ui_banner_default_image, R.drawable.core_ui_no_banner);
        typedArray.recycle();
    }
