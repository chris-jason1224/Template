...
import com.cj.ui.R;
import com.cj.ui.util.QMUIDisplayHelper;
...
public class UILoadingView extends View {
    ...
    public UILoadingView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.core_ui_QMUILoadingStyle);
    }
    ...
    public UILoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSize = array.getDimensionPixelSize(R.styleable.core_ui_QMUILoadingView_core_ui_qmui_loading_view_size, QMUIDisplayHelper.dp2px(context, 32));
